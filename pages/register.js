        ...
        <div className="z-10 relative">
          ...
          <div className="mt-20 md:mt-32">
            ...
            <p className="max-w-md" style={{ color: "#C7CFD6" }}>
              Take the quiz, get AI-matched career paths, and follow a step-by-step
              roadmap built around what actually excites you — not just the seven
              options everyone already knows about.
            </p>
          </div>
        </div>
      ...
      <div className="p-8 md:p-12 md:w-1/2 flex items-center justify-center" style={{ background: "#F7F5EF" }}>
        <div className="w-full max-w-md rounded-3xl p-8" style={{ background: "#FFFFFF", boxShadow: "0 10px 40px rgba(35,48,71,0.08)" }}>
          <div className="text-right mb-6 text-sm">
            <span style={{ color: "#3D6B78" }}>Already have an account? </span>
            <Link className="font-semibold" style={{ color: "#233047" }} href="/login">
              Sign in
            </Link>
          </div>
