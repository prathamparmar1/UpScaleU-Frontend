...
// ink navy   #233047  -- headings, primary chrome
// teal       #3D6B78  -- secondary accents, links
// amber      #C98A3E  -- goals / highlights / CTA
// sage       #4C8B5F  -- growth / success
// parchment  #F7F5EF  -- light section background
// border     #E4DFD2  -- warm hairlines

export default function Home() {
  return (
    <div style={{ background: "#F7F5EF" }}>
      {/* Hero Section */}
      <section className="relative text-white overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(1200px 600px at 15% -10%, rgba(201,138,62,0.25), transparent 60%), radial-gradient(1000px 700px at 100% 10%, rgba(76,139,95,0.20), transparent 55%), linear-gradient(160deg, #1A2438 0%, #233047 45%, #2E4A57 100%)",
          }}
        ></div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-around h-full">
            <div className="w-full md:w-1/2 mb-12 md:mb-0 relative">
              <p
                ...
                style={{ color: "#C98A3E" }}
              >
                Career clarity, built for you
              </p>
              <h1 className="text-5xl md:text-7xl font-bold mb-0 mt-4 leading-tight">
                Discover
              </h1>
              <h1 className="text-5xl md:text-8xl font-bold mb-6 leading-tight">
                <span
                  ...
                  style={{
                    backgroundImage: "linear-gradient(90deg, #C98A3E, #E0B072, #4C8B5F)",
                  }}
                >
                  Your Path
                </span>
              ...
              <p className="text-xl mb-8" style={{ color: "#C7CFD6" }}>
                Empowering students and professionals with clarity, mentorship, and
                tools to build impactful future careers.
              </p>

              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                <Link href="/quiz" className="group relative w-full sm:w-auto px-6 py-3 min-w-[160px]">
                  <div
                    className="absolute inset-0 rounded-lg"
                    style={{ background: "linear-gradient(90deg, #C98A3E, #3D6B78)" }}
                  ></div>
                  <div
                    className="absolute inset-0 rounded-lg lg:blur-md blur-0 group-hover:opacity-60 transition-opacity duration-500"
                    style={{ background: "linear-gradient(90deg, #C98A3E, #3D6B78)" }}
                  ></div>
                  <div className="relative flex items-center justify-center gap-2">
                    <span className="text-white font-medium">Start Your Quiz</span>
                    <svg
            ...
            <div className="w-full md:w-2/5 md:pl-12">
              <div
                className="relative rounded-xl p-8 shadow-2xl backdrop-blur-md"
              ...
              >
                ...
                <img
                  src="/logo.png"
                  alt="UpScaleU logo"
                  className="h-16 right-6 top-6 lg:block md:block hidden absolute opacity-90"
                />
                <ul className="space-y-5">
                  <li className="flex items-center gap-3">
                    <span
                      className="w-9 h-9 rounded-full flex items-center justify-center flex-shrink-0"
                      style={{ background: "rgba(201,138,62,0.18)" }}
                    >
                      <svg className="w-5 h-5" fill="none" stroke="#C98A3E" viewBox="0 0 24 24">
                        <path
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          strokeWidth="2"
                  ...
                  <li className="flex items-center gap-3">
                    <span
                      className="w-9 h-9 rounded-full flex items-center justify-center flex-shrink-0"
                      style={{ background: "rgba(76,139,95,0.18)" }}
                    >
                      <svg className="w-5 h-5" fill="none" stroke="#7FBF95" viewBox="0 0 24 24">
                        <path
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          strokeWidth="2"
                  ...
                  <li className="flex items-center gap-3">
                    <span
                      className="w-9 h-9 rounded-full flex items-center justify-center flex-shrink-0"
                      style={{ background: "rgba(61,107,120,0.25)" }}
                    >
                      <svg className="w-5 h-5" fill="none" stroke="#8FB6C2" viewBox="0 0 24 24">
                        <path
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          strokeWidth="2"
      ...
      <div className="h-auto md:h-[36rem] w-full rounded-md flex flex-col items-center justify-center relative overflow-hidden mx-auto py-16 md:py-0">
        <div className="p-4 relative z-10 w-full text-center max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight" style={{ color: "#233047" }}>
            Choose The Right Career For You
          </h1>
          <p className="mt-6 text-base md:text-lg leading-relaxed" style={{ color: "#5A6B78" }}>
            We help students and professionals discover their strengths, set clear
            career goals, and build a personalized roadmap to success. With tailored
            learning paths, smart recommendations, and real-time guidance, UpScaleU
            empowers you to bridge the gap between where you are and where you want to
            be. Whether you're exploring career options, upgrading skills, or preparing
            for interviews, UpScaleU is here to guide every step of your journey.
          </p>
          <div className="mt-8">
            <Link href={"/quiz"}>
              <Button
      ...
      <div
        className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 px-4 md:px-10 pb-16"
        style={{ background: "#F7F5EF" }}
      >
        {careerCardData.map((career) => (
          <CardContainer key={career.id} className="inter-var">
            <CardBody
              className="relative group/card w-auto sm:w-[26rem] h-auto rounded-xl p-6"
              style={{ background: "#FFFFFF", border: "1px solid #E4DFD2" }}
            >
              <CardItem translateZ="50" className="text-xl font-bold" style={{ color: "#233047" }}>
                {career.title}
              </CardItem>
              <CardItem as="p" translateZ="60" className="text-sm max-w-sm mt-2" style={{ color: "#5A6B78" }}>
                {career.description}
              </CardItem>
              ...
              <div className="flex justify-between items-center mt-6">
                ...
                <CardItem translateZ={20} as="div">
                  <Link
                    href={`/${career.slug}`}
                    className="px-4 py-2 rounded-xl text-white text-xs font-bold inline-block"
      ...
      <div
        className="h-[30rem] flex flex-col antialiased items-center justify-center relative overflow-hidden"
        style={{ background: "#233047" }}
      >
        <div
          className="bg-clip-text text-transparent text-center text-2xl md:text-4xl lg:text-6xl font-sans relative z-20 font-bold tracking-tight"
          style={{ backgroundImage: "linear-gradient(180deg, #FFFFFF, #C7CFD6)" }}
        >
          What People Say...
        </div>
        <BackgroundRippleEffect />
        <InfiniteMovingCards className={"mt-10"} items={testimonials} direction="right" speed="slow" />
      </div>
      ...
      <BackgroundBeamsWithCollision>
        <section className="pt-16 pb-7">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div
              className="grid grid-cols-1 lg:grid-cols-2 gap-12 pb-14 border-b-2"
              style={{ borderColor: "rgba(228,223,210,0.2)" }}
            >
              <div className="flex flex-col gap-8 xl:gap-14 w-full lg:max-w-full mx-auto">
                <div className="flex flex-col gap-8">
                  <h2 className="font-bold text-4xl leading-snug text-white max-[470px]:text-center">
                    Begin Your Career Journey!
                  </h2>
                  <p className="text-base font-normal max-[470px]:text-center" style={{ color: "#9AA7B0" }}>
                    Take the first step towards a career you're excited about.
                  </p>
                  <div className="flex items-center max-[470px]:justify-center gap-5">
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="p-2 text-white rounded-lg transition-all duration-300 hover:text-black focus-within:outline-0"
                ...
                <div className="flex flex-col min-[470px]:flex-row min-[470px]:items-center gap-3">
                  <Link href="/quiz">
                    <button
                      className="flex items-center max-[470px]:justify-center gap-2 py-3 pr-5 pl-7 rounded-full text-base font-semibold transition-all duration-500"
                      style={{ background: "#C98A3E", color: "#233047", border: "2px solid #C98A3E" }}
                    >
                      Have a Quiz
                  ...
                  <Link href="/contact">
                    <button
                      className="flex items-center max-[470px]:justify-center gap-2 py-2.5 pr-5 pl-7 rounded-full text-base font-semibold transition-all duration-500"
                      style={{ background: "transparent", color: "#FFFFFF", border: "2px solid rgba(255,255,255,0.35)" }}
                    >
                      Contact Us
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        <path
              ...
              <div className="w-full lg:max-w-full mx-auto flex flex-col min-[470px]:flex-row justify-between gap-16 sm:gap-20 md:gap-10 xl:gap-40">
                <div>
                  <h6 className="text-lg font-medium mb-7 max-[470px]:text-center" style={{ color: "#C7CFD6" }}>
                    UpScaleU
                  </h6>
                  <ul className="flex flex-col max-[470px]:items-center max-[470px]:justify-center gap-6">
                    {["Home", "About", "Pricing", "Pro Version"].map((item) => (
                      <li key={item}>
                        <a
                          href="#"
                          className="text-base font-normal max-lg:text-center whitespace-nowrap transition-all duration-300"
                          style={{ color: "#9AA7B0" }}
                        >
                          {item}
                        </a>
                ...
                <div>
                  ...
                  <ul className="flex flex-col max-[470px]:items-center max-[470px]:justify-center gap-6">
                    {["Career Quiz", "Roadmaps", "Skill Tracker", "Recommendations"].map((item) => (
                      <li key={item}>
                        <a
                          href="#"
                          className="text-base font-normal max-lg:text-center whitespace-nowrap transition-all duration-300"
                ...
                <div>
                  ...
                  <ul className="flex flex-col max-[470px]:items-center max-[470px]:justify-center gap-6">
                    {["FAQs", "Quick Start", "Documentation", "User Guide"].map((item) => (
                      <li key={item}>
                        <a
                          href="#"
                          className="text-base font-normal max-lg:text-center whitespace-nowrap transition-all duration-300"
            ...
            <div className="flex w-full flex-col-reverse gap-5 sm:flex-row items-center justify-between pt-7">
              <p className="font-normal text-sm" style={{ color: "#9AA7B0" }}>
                © UpScaleU 2026, All rights reserved.
              </p>
              <ul className="flex items-center gap-9">
                {["Terms", "Privacy", "Cookies"].map((item) => (
                  <li key={item}>
                    <a href="#" className="text-sm font-normal transition-all duration-300" style={{ color: "#9AA7B0" }}>
                      {item}
                    </a>
                  </li>
                ))}
